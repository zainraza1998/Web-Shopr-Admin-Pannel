...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <div class="welcome-msg pt-3 pb-4">
      <h1>Hi <span class="text-primary"><?php echo($name); ?></span>, Welcome back</h1>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <?php foreach($ob->total_pro() as $to){
                  echo $to['total'];
                } ?>
                </h3>
            ...
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-secondary number"><?php
                 $total = mysqli_fetch_array($ob->daily_order(),MYSQLI_ASSOC)['c'];
                 echo $total;
                ?></h3>
                <p class="stat-text">Daily orders</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-success number"><?php
                 $total = mysqli_fetch_array($ob->month_order(),MYSQLI_ASSOC)['c'];
                 echo $total;
                ?></h3>
                <p class="stat-text">Month Order</p>
              </div>
            </div>
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
      ...
      <div class="row">
        <div class="col-lg-6 pr-lg-2 chart-grid">
          <div class="card text-center card_border">
           ...
           <tbody>
<?php foreach($ob->total_pro_qty() as $qty){
  echo('
  <tr>
           <td>'.$qty['c_name'].'</td>
